...
@WebServlet("/api/trackingList.do")
public class TrackingListController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (!id_list.isEmpty()) {
            System.err.println("getByIdList");
          JSONObject query = rh.getByIdList(id_list);
          resp.put("status", "200");
          ...
          System.err.println(query.toString());
            ...
            System.err.println("noProsuct");
          resp.put("status", "400");
          resp.put("message", "追蹤清單內無商品！");
        }
